...
public class MainActivity extends Activity implements View.OnClickListener{
    ...
    public void bindButton(){
        ...
        edit= (EditText) findViewById(R.id.choose_table);
    ...
    public class JsonTable extends AsyncTask<String,Void,String[][][]>{

        @Override
        protected String[][][] doInBackground(String... params) {
            try {
                JSONTokener jsonTokener=new JSONTokener(params[0]);
